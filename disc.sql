...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jul 2022 pada 16.11
...
--
-- Struktur dari tabel `area_spv`
--

CREATE TABLE `area_spv` (
  `id_user` int(11) NOT NULL,
  `id_area` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `area_spv`
--

INSERT INTO `area_spv` (`id_user`, `id_area`) VALUES
(19, 1),
(19, 2),
(19, 3),
(19, 4),
...
CREATE TABLE `barang` (
  ...
  `box/pcs` int(50) NOT NULL,
  `harga` int(50) NOT NULL,
  `disc_rekomendasi` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `barang` (`id_barang`, `kode_barang`, `nama_barang`, `box/pcs`, `harga`, `disc_rekomendasi`) VALUES
(13, 'CCTPC15', 'COUNTERPAIN CREAM 15 GR', 144, 15000, 0),
(14, 'CCTPC30', 'COUNTERPAIN CREAM 30 GR', 60, 30000, 0),
(18, 'CCTPC120', 'COUNTERPAIN CREAM 120 GR', 60, 95000, 0);
...
INSERT INTO `keranjang` (`id_keranjang`, `id_user`, `id_pengajuan`, `id_toko`, `id_barang`, `jumlah`, `tanggal`, `status`) VALUES
(101, 3, 61, 5, 13, 10, '2022-07-14', 'disetujui'),
(102, 3, 62, 5, 14, 10, '2022-07-14', 'ditolak'),
(104, 3, 64, 5, 18, 10, '2022-07-14', 'diajukanADM'),
(105, 3, 65, 5, 14, 10, '2022-07-14', 'diajukanSPV');
...
INSERT INTO `logo` (`id_logo`, `image`) VALUES
(1, '1649489142_69cd7ddbe1881df19e19.png');
...
CREATE TABLE `order_barang` (
  ...
  `prsn_klaim` float NOT NULL,
  `disc_rek` int(11) NOT NULL,
...
INSERT INTO `order_barang` (`id_pengajuan`, `id_user`, `id_toko`, `id_keranjang`, `id_disc`, `prsn_klaim`, `disc_rek`, `total`, `status`, `status_klaim`, `tanggal_pengajuan`, `note`) VALUES
(61, 3, 5, 101, 10, 0, 0, 148500, 'disetujui', 1, '2022-07-14', NULL),
(62, 3, 5, 102, 11, 0, 0, 297000, 'ditolak', 1, '2022-07-14', 'tolak'),
(64, 3, 5, 104, 10, 0, 0, 940500, 'diajukanADM', 1, '2022-07-14', NULL),
(65, 3, 5, 105, 10, 0, 0, 297000, 'diajukanSPV', 1, '2022-07-14', NULL);

--
-- Trigger `order_barang`
--
DELIMITER $$
CREATE TRIGGER `deleteKeranjang` AFTER DELETE ON `order_barang` FOR EACH ROW DELETE FROM keranjang WHERE id_pengajuan = old.id_pengajuan
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateKeranjang` AFTER INSERT ON `order_barang` FOR EACH ROW UPDATE keranjang SET id_pengajuan = new.id_pengajuan, status = 'diajukanSPV', id_toko = new.id_toko WHERE id_user = new.id_user AND status = 'keranjang'
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updateKeranjang2` AFTER UPDATE ON `order_barang` FOR EACH ROW UPDATE keranjang SET status =
CASE
when new.status = 'diajukanADM' then 'diajukanADM'
...
--
-- Struktur dari tabel `program_disc`
--

CREATE TABLE `program_disc` (
  `id_disc` int(11) NOT NULL,
  `disc_reguler` int(50) DEFAULT NULL,
  `promotgl` int(50) DEFAULT NULL,
  `disc_klaim` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `program_disc`
--

INSERT INTO `program_disc` (`id_disc`, `disc_reguler`, `promotgl`, `disc_klaim`) VALUES
(10, 0, 1, 0),
(11, 0, 1, 1.5),
(12, 2, 1, 0),
(13, 2, 0, 0);
...
CREATE TABLE `toko` (
  ...
  `chanel` enum('Apotek','PBF','Toko Obat','') NOT NULL,
...
INSERT INTO `toko` (`id_toko`, `kode_toko`, `nama_toko`, `alamat_toko`, `chanel`, `region`) VALUES
(5, 29272383, 'Haji Umar', 'Jalan Cipayung, No 64 Kecamatan Cipayung', 'Apotek', 'KOTA AMBON'),
(8, 2927238, 'Toko Disc', 'Jakarta', 'Apotek', 'KABUPATEN ACEH BARAT');

--
-- Trigger `toko`
--
DELIMITER $$
CREATE TRIGGER `deleteOrder` AFTER DELETE ON `toko` FOR EACH ROW DELETE FROM order_barang WHERE id_toko = old.id_toko
$$
DELIMITER ;
...
CREATE TABLE `user` (
  ...
  `level` enum('Op','admin','user','spv') NOT NULL,
...
INSERT INTO `user` (`id_user`, `id_area`, `nama_user`, `username`, `password`, `level`, `avatar`, `created_at`) VALUES
(1, 6, 'Admin Operator', 'operator', '12345', 'Op', '1649498467_2d89dd06a9a3ed3334d1.png', '2022-07-13 18:40:55'),
(2, 1, 'Manager', 'Manager', '123456', 'admin', '1657741147_a40824ce691175e2f5d6.png', '2022-07-13 19:39:07'),
(3, 3, 'Sales Jakut', 'Sales JKU', '12345', 'user', '1649504051_c94884eef802bcb43e2d.png', '2022-07-13 18:45:18'),
(19, 1, 'Super Visor', 'spvisor', '12345', 'spv', '1657741316_8f205bae3ec524238e58.png', '2022-07-13 19:41:56');
...
--
-- Indeks untuk tabel `area_spv`
--
ALTER TABLE `area_spv`
...
--
-- Indeks untuk tabel `program_disc`
--
ALTER TABLE `program_disc`
...
--
ALTER TABLE `order_barang`
  MODIFY `id_pengajuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT untuk tabel `program_disc`
--
ALTER TABLE `program_disc`
  MODIFY `id_disc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
